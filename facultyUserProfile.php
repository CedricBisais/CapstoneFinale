...
?>
    ...
    <nav class="nav container">
        <a class="navbar-brand mt-2 mt-lg-0" href="facultyHomepage.php">
...
<div class="content py-4">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="facultyUserEditProfile.php" method="POST">
...
<script>
    ...
    <div class="modal fade" id="changePassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <form action="facultyUserChangePassword.php" method="POST">
            <div class="modal-body">
        <div class="mb-3">
...
<div class="modal fade" id="profilePicture" tabindex="-1" aria-labelledby="profilePictureModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="facultyUserProfilePicture.php" method="POST" enctype="multipart/form-data">
