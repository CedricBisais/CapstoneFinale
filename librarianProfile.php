...
?>
    ...
    <head>
        ...
        <!-- Cropper.js -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.css" integrity="sha512-tEnMXFWlq2sjM5qjblt9wA9dFJFPzuz0fgLDYcO+LeQTf8MQYbFyRFnAE+peS98EMiQ2Z3IQk0XhqWfLyZcN2A==" crossorigin="anonymous" />
        <script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.js" integrity="sha512-BsFSy8nLH/zDaq8Ux7voZBqzBQxlFn1ItGnZGXTX0eXRS4+dDZpntHu7dJnA5Irl5d9VR4EdXsXfi/t31xepcA==" crossorigin="anonymous"></script>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="librarianUserEditProfile.php" method="POST">
    ...
    <script>
        ...
        <div class="modal fade" id="changePassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <form action="librarianUserChangePassword.php" method="POST">
                <div class="modal-body">
            <div class="mb-3">
    ...
    <div class="modal fade" id="profilePicture" tabindex="-1" aria-labelledby="profilePictureModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="librarianUserProfilePicture.php" method="POST" enctype="multipart/form-data">
