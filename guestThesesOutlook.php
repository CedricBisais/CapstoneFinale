            ...
            <div class="col-12">
                <div class="card card-outline card-primary shadow rounded-0">
                    <div class="card-body rounded-0">
                        <h2>Archive List</h2>
                        <hr class="bg-navy">
                        <form action="guestThesesOutlook.php" method="GET" class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="pagination pagination-sm m-0 float-right">
                                            <?php if ($page > 1) : ?>
                                                <li class="page-item"><a class="page-link" href="guestThesesOutlook.php?p=<?= $page - 1 . $search ?>">«</a></li>
                                            <?php endif; ?>
                                            <?php for ($i = 1; $i <= $pages; $i++) : ?>
                                                <li class="page-item <?= $page == $i ? 'active' : '' ?>"><a class="page-link" href="guestThesesOutlook.php?p=<?= $i . $search ?>"><?= $i ?></a></li>
                                            <?php endfor; ?>
                                            <?php if ($page < $pages) : ?>
                                                <li class="page-item"><a class="page-link" href="guestThesesOutlook.php?p=<?= $page + 1 . $search ?>">»</a></li>
                                            <?php endif; ?>
